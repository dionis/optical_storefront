...
PROFILE_PROMPT = (
    "IMAGE 1 is a FRONTAL photograph of a person. IMAGE 2 is a photograph of an eyewear "
    "frame. Produce ONE photorealistic image of the SAME person, seen in PROFILE (side "
    "view, roughly 90 degrees, looking to the left of the frame), wearing the EXACT frame "
    "from IMAGE 2.\n"
    "Hard constraints:\n"
    "- Same person: the identity, age, skin texture, wrinkles, hair and build must stay "
    "recognisably those of IMAGE 1. No beautifying, smoothing, slimming or rejuvenating. "
    "A side view is already an extrapolation; changing the person on top of that would "
    "make it a picture of somebody else.\n"
    "- Keep the frame's shape, colour, material and proportions exactly as in IMAGE 2.\n"
    "- This view exists to show the FIT AT THE SIDE, so it must read clearly: the temple "
    "running from the hinge back to the ear, where it rests on top of the ear, the "
    "pantoscopic tilt of the front, and the gap between the rim and the cheek.\n"
    "- Neutral head position, no tilt, eye level with the camera.\n"
    "Return only the image."
)
